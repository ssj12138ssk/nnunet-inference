...
if __name__ == '__main__':
    folder_ref = '/data/data1/zxy/data/nnUnet_raw/Dataset701_Hip/labelsTs/'
    folder_pred = '/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainerNoMirroring__nnUNetPlans__3d_fullres/fold_all/test/'
    output_file = '/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainerNoMirroring__nnUNetPlans__3d_fullres/fold_all/summary.json'
