...
class nnUNetPredictor(object):
    ...
    def predict_from_data_iterator(self,
        ...
        with multiprocessing.get_context("spawn").Pool(num_processes_segmentation_export) as export_pool:
            ...
            for preprocessed in data_iterator:
               ...
               #print(f'This is ibotserver branch!')
    ...
    def _internal_maybe_mirror_and_predict(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # sitk.WriteImage(sitk.GetImageFromArray(x[0,0].cpu().numpy().astype(np.float32)), "/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_all/test1/input.nii.gz")
        ...
        # sitk.WriteImage(sitk.GetImageFromArray(prediction[0].cpu().numpy().transpose([1,2,3,0]).astype(np.float32)), "/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_all/test1/output.nii.gz")
        # assert 1==0
    ...
    def predict_sliding_window_return_logits(self, input_image: torch.Tensor) \
        ...
        # import SimpleITK as sitk
        # sitk.WriteImage(sitk.GetImageFromArray(input_image[0].cpu().numpy().astype(np.float32)), "/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_all/test1/input.nii.gz")
        # sitk.WriteImage(sitk.GetImageFromArray(predicted_logits.cpu().numpy().transpose([1,2,3,0]).astype(np.float32)), "/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_all/test1/output.nii.gz")
        # assert 1==0
