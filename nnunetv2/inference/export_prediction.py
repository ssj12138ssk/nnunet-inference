...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    # sitk.WriteImage(sitk.GetImageFromArray(predicted_logits.cpu().numpy().transpose([1,2,3,0]).astype(np.float32)), "/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_all/test1/input.nii.gz")
    
    transpose = plans_manager.transpose_backward
    new_spacing = properties_dict['spacing']
    new_spacing = [new_spacing[transpose[0]], new_spacing[transpose[1]], new_spacing[transpose[2]]]
    ...
    # sitk.WriteImage(sitk.GetImageFromArray(predicted_logits.transpose([1,2,3,0]).astype(np.float32)), "/data/data1/zxy/data/nnUnet_results/Dataset701_Hip/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_all/test1/output.nii.gz")
    # assert 1==0
